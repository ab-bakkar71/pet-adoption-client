    ...
    return (
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8 border-b border-slate-200/60 dark:border-slate-800/60 pb-6">
          ...
          <button className="inline-flex items-center justify-center gap-2 px-5 h-11 text-sm font-semibold rounded-xl text-white bg-emerald-500 hover:bg-emerald-600 active:scale-[0.98] transition-all shadow-md shadow-emerald-500/10 cursor-pointer">
            ...
            <div className="p-6 rounded-2xl border bg-white border-slate-200 shadow-sm dark:bg-slate-900/40 dark:border-slate-800/80">
              <div className="flex flex-col items-center text-center">
                ...
                <div className="w-20 h-20 rounded-full bg-gradient-to-tr from-cyan-500 to-emerald-500 p-0.5 shadow-md">
                  <div className="w-full h-full rounded-full bg-white dark:bg-slate-900 flex items-center justify-center font-black text-2xl text-cyan-600 dark:text-cyan-400">
                    {currentUser.name.charAt(0)}
                  </div>
                </div>
                
                <h3 className="mt-4 font-bold text-lg text-slate-900 dark:text-white">{currentUser.name}</h3>
