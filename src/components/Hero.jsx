...
const Hero = () => {
    return (
        <div className="relative min-h-[85vh] bg-gradient-to-br from-amber-50 via-orange-50 to-emerald-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 flex items-center overflow-hidden transition-colors duration-300">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div className="space-y-6 text-center lg:text-left z-10 animate__fadeInLeft animate__animated animate__slower">
                        ...
                        <div className="pt-4 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                            <Link
                                href="/all-pets"
                                className="w-full sm:w-auto bg-orange-600 hover:bg-orange-700 text-white font-bold px-8 py-4 rounded-xl shadow-lg hover:shadow-orange-200 transition-all duration-300 flex items-center justify-center gap-2 group cursor-pointer"
                            >
                                Adopt Now
                            ...
                            <Link
                                ...
                                className="w-full sm:w-auto border border-slate-300 dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-800 dark:text-slate-100 font-bold px-8 py-4 rounded-xl transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer"
                            >
                                List a Pet
                            </Link>
                        </div>
                    ...
                    <div className="relative flex justify-center items-center animate__fadeInRight animate__animated animate__slower">
                        <div className="absolute inset-0 bg-gradient-to-tr from-orange-400 to-amber-300 rounded-3xl transform rotate-3 scale-102 opacity-20" />

                        <div className="relative rounded-3xl overflow-hidden shadow-2xl border-4 border-white dark:border-slate-800 max-w-[500px] lg:max-w-full w-full h-[350px] sm:h-[450px]">
                            <Image
                            ...
                            <div className="absolute bottom-4 left-4 bg-white/90 dark:bg-slate-900/90 backdrop-blur-md p-4 rounded-2xl shadow-lg flex items-center gap-3 border border-white/20 dark:border-slate-800">
